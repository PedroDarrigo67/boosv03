                ...
                <Row>
                  ...
                  <Col sm={5}>
                    ...
                    <Row>
                      ...
                      <Col sm={4} my={1} py={1}>
                        <div className="bg-image hover-zoom">
                         {post.imagef && <img src={post.imagef.url} alt={post.title} className="w-100 p-0 rounded-3"/>}
                         </div>
                      </Col>   
                      <Col sm={4} my={1} py={1}>
                        <div className="bg-image hover-zoom">
                         {post.imageg && <img src={post.imageg.url} alt={post.title} className="w-100 p-0 rounded-3"/>}
                         </div>
                      </Col>                            
                        <Col sm={4} my={1} py={1}>
                        <div className="bg-image hover-zoom">
                         {post.imageh && <img src={post.imageh.url} alt={post.title} className="w-100 p-0 rounded-3"/>}
                         </div>
                        </Col>       
                    </Row>
